...
SECRET_KEY = 'django-insecure-*j1374q(33d9e)mxunczdoa(a7mp%#@@0-nomp$+z@y4_(sitl'
...
STATIC_URL = 'static/'
# add the folder where media and images will be stored and locate it in the root of the project 
MEDIA_URL = 'media/'
